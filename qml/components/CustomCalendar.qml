...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            text: calendar.months[calendar.currentMonth].slice(0, 3) + " " + calendar.currentDay + "号 " + calendar.weekNames[calendar.week].slice(0, 3)
    ...
    ListView {
        ...
        property var months: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]
        ...
        delegate: Rectangle {
            ...
            MonthGrid {
                ...
                delegate: Rectangle {
                    ...
                    color: enabled && highlighted ? "#0097A7" : "white"
    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            Text {
                anchors.centerIn: parent
                font.pixelSize: mainForm.fontSizePx * 1.5
                text: calendar.months[index]
                scale: index == calendar.months.indexOf(monthList.currentMonth) ? 1.5 : 1
                color: "#0097A7"
            }
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    calendarModel.setMonth(index);
                    monthList.hide();
                }
            }
        }
        ...
        function show() {
            ...
            monthList.positionViewAtIndex(calendar.months.indexOf(currentMonth), ListView.SnapToItem);
        }
        function hide() {
            visible = false;
            calendar.visible = true;
